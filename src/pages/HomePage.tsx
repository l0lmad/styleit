      ...
      <section className="relative overflow-hidden text-white" style={{ background: `linear-gradient(135deg, ${siteSettings.primaryColor}, ${siteSettings.secondaryColor}, #4338ca)` }}>
        ...
        {siteSettings.showHeroWatermark && (
          <div className="absolute inset-0 pointer-events-none"
            style={{ backgroundImage: `url(${logoSrcFinal})`, backgroundSize: '100% 100%', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', opacity: 0.06 }}
          />
        )}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        >
          {siteSettings.showSaleWatermark && (
            <div className="absolute inset-0 pointer-events-none"
              style={{ backgroundImage: `url(${logoSrcFinal})`, backgroundSize: '100% 100%', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', opacity: 0.1 }}
            />
          )}
